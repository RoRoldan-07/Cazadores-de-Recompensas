...
public class CazadorSigilosoTest {
	...
	@Test
	public void quePuedaCazarUnProfugoDeBajaInocenciaYHabilidadMenorA50() throws ProfugoNuloException, ValorInvalidoException, CazadorSinNombreException {
		CazadorSigiloso cazadorSigiloso = new CazadorSigiloso("Pedro", 50);
	...
	@Test
	public void queNoPuedaCazarUnProfugoDeNivel50DeHabilidad() throws ProfugoNuloException, ValorInvalidoException, CazadorSinNombreException {
		CazadorSigiloso cazadorSigiloso = new CazadorSigiloso("Pedro", 50);
	...
	@Test
	public void queNoPuedaCazarUnProfugoPorHabilidadYLoPuedaIntimidar() throws ProfugoNuloException, ValorInvalidoException, CazadorSinNombreException {
		CazadorSigiloso cazadorSigiloso = new CazadorSigiloso("Pedro", 50);
		ProfugoBase profugo1 = new ProfugoBase("Jorge", 40, 50, false);
	...
	@Test
	public void queLaHabilidadDelProfugoNoPuedaSerMenorACero() throws ProfugoNuloException, ValorInvalidoException, CazadorSinNombreException {
		CazadorSigiloso cazadorSigiloso = new CazadorSigiloso("Pedro", 50);
